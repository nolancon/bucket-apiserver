...
import (
	...
	v1alpha1 "k8s.io/sample-apiserver/pkg/generated/clientset/versioned/typed/providerceph/v1alpha1"
)

type FakeProvidercephV1alpha1 struct {
	*testing.Fake
}

func (c *FakeProvidercephV1alpha1) Buckets(namespace string) v1alpha1.BucketInterface {
